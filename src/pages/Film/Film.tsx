...
import { IFullFilm, IPrequels, IReviews, IFilmsSimilar, IStaff, IFilmFacts, IFilmImages, IFilmAwards, IFilmTrailer } from "../../types/IFilm"
...
const resolveType = (review: ITypes): string | undefined => {
    if (review === 'POSITIVE') {
    ...
    return (
        <Container>
            <main className={styles.main}>
                ...
                <section>
                    {
                        filmsSimilar ? filmsSimilar.items.length > 5
                            &&
